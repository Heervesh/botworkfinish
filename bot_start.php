...
$irc->setDebug( $config->get('bot_debugging', 0) ? SMARTIRC_DEBUG_ALL : SMARTIRC_DEBUG_NONE );
...
$irc->connect($config->get('bot_server', 'irc.freenode.net'),$config->get('bot_server_port', 6667));
$irc->login($config->get('bot_nickname', 'bot_module'),$config->get('bot_nickname', 'bot_module').' :http://drupal.org/project/bot', 8,$config->get('bot_nickname', 'bot_module'));
$irc->join(preg_split('/\s*,\s*/', $config->get('bot_channels', '#test')));
